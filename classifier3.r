files <- c("Tecan_m1000/1_Fluo_mCherry/20240304-133949_240229MR_3.xlsx",
           "Tecan_m1000/3_Lum_Minor/20240304-143530_240229MR_3.xlsx",
           "Tecan_m1000/2_Lum_Major/20240304-135404_240229MR_3.xlsx")
# ============================ Library prep ====================================
...
filtered_data_major_3
input_data_3
filtered_data_major_3
combined_data_3.xlsx
x_fold_3.xlsx
filtered_data_minor_3_strict.xlsx
filtered_data_major_3_strict.xlsx
# ------------------------------------------------------------------------------
...
#input_data_3 <- as.data.frame(input_data_3)
...
input_data_3[,11][input_data_3[,11] < 0] <- NA
input_data_3[,3][input_data_3[,3] < 0] <- NA
...
input_data_3[287,] # This should return L24
...
input_data_3$x_fold_major <- 1/ control_major * input_data_3$calc_column_major
head(input_data_3$x_fold_major)
head(input_data_3$x_fold_minor)
str(input_data_3)
# Assuming the calculations for these columns are done correctly above, 
# adjust the assignment:
input_data_3$calc_column_minor <- input_data_3$calc_column_minor[[1]]
input_data_3$calc_column_major <- input_data_3$calc_column_major[[1]]
input_data_3$x_fold_minor <- input_data_3$x_fold_minor[[1]]
input_data_3$x_fold_major <- input_data_3$x_fold_major[[1]]
# After correcting the structure, proceed to write the data frame to an Excel file
write_xlsx(input_data_3, "combined_data_3.xlsx")

# ======================== Strict parameters ===================================
filtered_data_minor_3 <- input_data_3[input_data_3$x_fold_minor <= 0.7 & 
                                        input_data_3$x_fold_major >= 1, ]
filtered_data_major_3 <- input_data_3[input_data_3$x_fold_minor >= 1 & 
                                        input_data_3$x_fold_major <= 0.5, ]

write_xlsx(filtered_data_major_3, "filtered_data_major_3_strict.xlsx")
write_xlsx(filtered_data_minor_3, "filtered_data_minor_3_strict.xlsx")
# ========================= end of strict ======================================
